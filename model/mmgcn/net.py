...
class Net(nn.Module):
    def __init__(self, num_users, num_items, emb_dim, dim_feats, device):
        ...
        self.t_gcn = GCN(self.num_user, self.num_item, self.dim_feats[0], dim_x,
    ...
    def forward(self, edge_index, feats, id_embedding):
        ...
        self.v_feat = feats[0]
        self.t_feat = feats[1]
        representation, preference = self.v_gcn(edge_index, self.v_feat, self.id_embedding)
        representation += self.t_gcn(edge_index, self.t_feat, self.id_embedding)[0]
